...
export var login = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, password, user, passwordIsValid, secretKey, token;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                if (!user) {
                    return [2 /*return*/, res.sendStatus(401).json({ message: 'Authentication failed' })];
                }
            ...
            case 2:
                ...
                token = jwt.sign({ username: username }, secretKey, { expiresIn: '1h' });
                // return the token

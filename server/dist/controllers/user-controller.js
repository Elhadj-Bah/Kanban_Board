...
// GET /Users
export var getAllUsers = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var users, error_1;
...
// GET /Users/:id
export var getUserById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, user, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
export var createUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, password, newUser, error_3;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, User.create({ username: username, password: password })];
            case 2:
                newUser = _b.sent();
...
export var updateUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, username, password, user, error_4;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                id = req.params.id;
